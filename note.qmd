...
#| eval: false
#| echo: true
tictoc::tic(); df_small <- readr::read_csv("data/tokyo202101_small.csv"); tictoc::toc()
tictoc::tic(); dt_small <- data.table::fread("data/tokyo202101_small.csv"); tictoc::toc()
tictoc::tic(); df_arw_small <- read_csv_arrow("data/tokyo202101_small.csv"); tictoc::toc()
```
...
#| eval: false
#| echo: true
tictoc::tic(); df_year <- readr::read_csv("data/tokyo2021_medium.csv"); tictoc::toc()
tictoc::tic(); dt_year <- data.table::fread("data/tokyo2021_medium.csv"); tictoc::toc()
tictoc::tic(); df_arw_year <- read_csv_arrow("data/tokyo2021_medium.csv"); tictoc::toc()
```
